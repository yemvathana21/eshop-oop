...
class AdminController extends Controller {
    ...
    public function dashboard() {
        ...
        $this->render('admin/dashboard', [
            'title' => 'Admin Dashboard - General Online Store',
    ...
    public function products() {
        ...
        $this->render('admin/products', [
            'title' => 'Product Management - General Online Store',
            'products' => $products,
            'currentPage' => $page,
    ...
    public function productCreate() {
        ...
        $this->render('admin/product_form', [
            'title' => 'Add Product - General Online Store',
            'product' => null,
    ...
    public function productEdit() {
        ...
        $this->render('admin/product_form', [
            'title' => 'Edit Product - General Online Store',
            'product' => $product,
            'topCategories' => $topCategories,
    ...
    public function orders() {
        ...
        $this->render('admin/orders', [
            'title' => 'Order Management - General Online Store',
            'orders' => $enriched,
    ...
    public function orderDetail() {
        ...
        $this->render('admin/order_detail', [
            'title' => 'Order #' . $order['invoice_number'] . ' - General Online Store',
            'order' => $order,
            'items' => $items
        ], 'admin');
    }
    ...
    public function inventory() {
        ...
        $this->render('admin/inventory', [
            'title' => 'Inventory Management - General Online Store',
            'products' => $products,
            'lowStock' => $lowStock,
    ...
    public function orderInvoice() {
        ...
        $this->render('customer/invoice', [
            'title' => 'Invoice ' . $invoiceNumber . ' - General Online Store',
            'order' => $order,
            'items' => $items,
            'isAdmin' => true
        ], 'admin');
    ...
    public function categories() {
        ...
        $this->render('admin/categories', [
            'title' => 'Category Management - General Online Store',
    ...
    public function categoryCreate() {
        ...
        $this->render('admin/category_form', [
            'title' => 'Add Category - General Online Store',
            'category' => null,
    ...
    public function categoryEdit() {
        ...
        $parentCategories = $this->categoryModel->parentCategories();
        $this->render('admin/category_form', [
            'title' => 'Edit Category - General Online Store',
            'category' => $category,
            'parentCategories' => $parentCategories
        ], 'admin');
    }
    ...
    public function users() {
        ...
        $this->render('admin/users', [
            'title' => 'Registered Customer - General Online Store',
            'users' => $users
        ], 'admin');
    }
    ...
    public function userCreate() {
        $this->render('admin/user_form', [
            'title' => 'Add User - General Online Store',
            'user' => null
        ], 'admin');
    }
    ...
    public function userEdit() {
        ...
        $this->render('admin/user_form', [
            'title' => 'Edit User - General Online Store',
            'user' => $user
        ], 'admin');
    }
    ...
    public function reviews() {
        ...
        $this->render('admin/reviews', [
            'title' => 'Customer Reviews - General Online Store',
            'reviews' => $reviews
        ], 'admin');
    }
    ...
    public function sizes() {
        ...
        $this->render('admin/settings/sizes', [
            'title' => 'Manage Sizes - General Online Store',
            'sizes' => $model->all()
        ], 'admin');
    }
    ...
    public function colors() {
        ...
        $this->render('admin/settings/colors', [
            'title' => 'Manage Colors - General Online Store',
            'colors' => $model->all()
        ], 'admin');
    }
    ...
    public function topCategories() {
        $this->render('admin/settings/top_categories', [
            'title' => 'Top Level Categories - General Online Store',
    ...
    public function midCategories() {
        ...
        $this->render('admin/settings/mid_categories', [
            'title' => 'Mid Level Categories - General Online Store',
    ...
    public function endCategories() {
        ...
        $this->render('admin/settings/end_categories', [
            'title' => 'End Level Categories - General Online Store',
    ...
    public function shippingMethods() {
        ...
        $this->render('admin/settings/shipping_methods', [
            'title' => 'Manage Shipping Methods - General Online Store',
            'methods' => $model->all()
        ], 'admin');
    }
    ...
    public function qrCode() {
        ...
        $this->render('admin/settings/qrcode', [
            'title' => 'Manage QR Code - General Online Store',
            'hasQr' => $hasQr,
    ...
    public function contactSettings() {
        ...
        $this->render('admin/settings/contact', [
            'title' => 'Contact Settings - General Online Store',
            'settings' => $settings
        ], 'admin');
    }

    public function contactSettingsSave() {
        if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
            $this->redirect('admin/settings/contact');
        }

        $settingModel = new Setting();
        $fields = [
            'store_name', 'store_email', 'store_phone', 'store_address',
            'store_map', 'facebook_url', 'telegram_url', 'tiktok_url'
        ];
        ...
        foreach ($fields as $field) {
            ...
            // If user pasted the whole iframe tag for the map, extract just the src URL
            if ($field === 'store_map' && !empty($val) && strpos($val, '<iframe') !== false) {
        ...
        if ($settingModel->updateMultiple($data)) {
            Session::setFlash('success', 'Contact settings updated successfully.');
        } else {
            Session::setFlash('error', 'Failed to update contact settings.');
        }
    ...
    public function messages() {
        ...
        $messages = $cmModel->all();

        $this->render('admin/messages', [
            'title' => 'Customer Messages - General Online Store',
            'messages' => $messages
        ], 'admin');
    }
    ...
    public function messageDetail() {
        ...
        if ($message['status'] === 'unread') {
            $cmModel->updateStatus($id, 'read');
        }

        $this->render('admin/message_detail', [
            'title' => 'Message Detail - General Online Store',
            'message' => $message
        ], 'admin');
    }
    ...
    public function messageReply() {
        ...
        if (!$id || empty($reply)) {
            ...
            $this->redirect('admin/message?id=' . $id);
        }

        $cmModel = new ContactMessage();
        if ($cmModel->saveReply($id, $reply)) {
            Session::setFlash('success', 'Reply saved successfully.');
        } else {
            Session::setFlash('error', 'Failed to save reply.');
        }
