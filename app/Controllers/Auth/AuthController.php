...
class AuthController extends Controller {
    ...
    public function showLogin() {
        ...
        $this->render('customer/login', ['title' => 'Login - General Online Store'], 'auth');
    }
    ...
    public function showAdminLogin() {
        ...
        $this->render('admin/login', ['title' => 'Admin Login - General Online Store'], 'admin_auth');
    }
    ...
    public function showRegister() {
        ...
        $this->render('customer/register', ['title' => 'Register - General Online Store'], 'auth');
    }
