<div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
    ...
    <div class="lg:col-span-1">
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
            <h2 id="formTitle" class="text-lg font-bold text-gray-900 dark:text-white mb-4">Add New Country</h2>
            <form action="<?= BASE_URL ?>admin/country/save" method="POST" id="countryForm">
            ...
            <table class="w-full text-sm">
                <thead>
                    <tr class="bg-gray-50 dark:bg-gray-700 border-b border-gray-100 dark:border-gray-600 text-left">
                        ...
                        <th class="py-3 px-4 font-semibold text-gray-600 dark:text-gray-300">Country Name</th>
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                    ...
                    <tr>
                        <td colspan="3" class="py-10 text-center text-gray-500">No countries found.</td>
                    </tr>
                    <?php else: ?>
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition">
                            ...
                            <td class="py-3 px-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <button onclick="editCountry(<?= $c['id'] ?>, '<?= addslashes($c['name']) ?>')" class="text-blue-500 hover:text-blue-700 p-1">
                                        <i class="fas fa-edit"></i>
                                    </button>
                                    <a href="<?= BASE_URL ?>admin/country/delete?id=<?= $c['id'] ?>" onclick="return confirm('Are you sure?')" class="text-red-500 hover:text-red-700 p-1">
...
function editCountry(id, name) {
    document.getElementById('formTitle').textContent = 'Edit Country';
...
function resetForm() {
    document.getElementById('formTitle').textContent = 'Add New Country';
