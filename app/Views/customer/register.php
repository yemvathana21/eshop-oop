<div class="text-center mb-8">
    <h2 class="text-2xl font-bold text-gray-800 dark:text-white"><?= t('create_account') ?></h2>
    <p class="text-gray-500 dark:text-gray-400 mt-1 text-sm"><?= t('join_eshop') ?></p>
</div>
...
<p class="text-center text-sm text-gray-500 dark:text-gray-400 mt-6">
    <?= t('already_have_account') ?> <a href="<?= BASE_URL ?>login" class="text-blue-600 dark:text-blue-400 hover:underline font-medium"><?= t('sign_in') ?></a>
</p>
